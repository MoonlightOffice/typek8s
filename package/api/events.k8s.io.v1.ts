export interface paths {
  "/apis/events.k8s.io/v1/": {
    ...
    get: operations["getEventsV1APIResources"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/events.k8s.io/v1/events": {
    ...
    get: operations["listEventsV1EventForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/events.k8s.io/v1/namespaces/{namespace}/events": {
    ...
    /** @description list or watch objects of kind Event */
    get: operations["listEventsV1NamespacedEvent"]
    put?: never
    /** @description create an Event */
    post: operations["createEventsV1NamespacedEvent"]
    /** @description delete collection of Event */
    delete: operations["deleteEventsV1CollectionNamespacedEvent"]
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  "/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}": {
    ...
    get: operations["readEventsV1NamespacedEvent"]
    /** @description replace the specified Event */
    put: operations["replaceEventsV1NamespacedEvent"]
    post?: never
    /** @description delete an Event */
    delete: operations["deleteEventsV1NamespacedEvent"]
    options?: never
    head?: never
    /** @description partially update the specified Event */
    patch: operations["patchEventsV1NamespacedEvent"]
    trace?: never
  }
  "/apis/events.k8s.io/v1/watch/events": {
    ...
    get: operations["watchEventsV1EventListForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events": {
    ...
    /** @description watch individual changes to a list of Event. deprecated: use the 'watch' parameter with a list operation instead. */
    get: operations["watchEventsV1NamespacedEventList"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events/{name}": {
    ...
    get: operations["watchEventsV1NamespacedEvent"]
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface operations {
  ...
  listEventsV1EventForAllNamespaces: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.events.v1.EventList"]
          "application/json;stream=watch": components["schemas"]["io.k8s.api.events.v1.EventList"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.events.v1.EventList"]
          "application/vnd.kubernetes.protobuf;stream=watch": components["schemas"]["io.k8s.api.events.v1.EventList"]
          "application/yaml": components["schemas"]["io.k8s.api.events.v1.EventList"]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  createEventsV1NamespacedEvent: {
    ...
    requestBody: {
      content: {
        "*/*": components["schemas"]["io.k8s.api.events.v1.Event"]
      }
    }
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.events.v1.Event"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.events.v1.Event"]
          "application/yaml": components["schemas"]["io.k8s.api.events.v1.Event"]
        }
      }
      /** @description Created */
      201: {
