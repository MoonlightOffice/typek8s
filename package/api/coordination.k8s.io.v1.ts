export interface paths {
  "/apis/coordination.k8s.io/v1/": {
    ...
    get: operations["getCoordinationV1APIResources"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/coordination.k8s.io/v1/leases": {
    ...
    get: operations["listCoordinationV1LeaseForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases": {
    ...
    /** @description list or watch objects of kind Lease */
    get: operations["listCoordinationV1NamespacedLease"]
    put?: never
    /** @description create a Lease */
    post: operations["createCoordinationV1NamespacedLease"]
    /** @description delete collection of Lease */
    delete: operations["deleteCoordinationV1CollectionNamespacedLease"]
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}": {
    ...
    get: operations["readCoordinationV1NamespacedLease"]
    /** @description replace the specified Lease */
    put: operations["replaceCoordinationV1NamespacedLease"]
    post?: never
    /** @description delete a Lease */
    delete: operations["deleteCoordinationV1NamespacedLease"]
    options?: never
    head?: never
    /** @description partially update the specified Lease */
    patch: operations["patchCoordinationV1NamespacedLease"]
    trace?: never
  }
  "/apis/coordination.k8s.io/v1/watch/leases": {
    ...
    get: operations["watchCoordinationV1LeaseListForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases": {
    ...
    /** @description watch individual changes to a list of Lease. deprecated: use the 'watch' parameter with a list operation instead. */
    get: operations["watchCoordinationV1NamespacedLeaseList"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases/{name}": {
    ...
    get: operations["watchCoordinationV1NamespacedLease"]
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface operations {
  ...
  listCoordinationV1LeaseForAllNamespaces: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.coordination.v1.LeaseList"]
          "application/json;stream=watch": components["schemas"]["io.k8s.api.coordination.v1.LeaseList"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.coordination.v1.LeaseList"]
          "application/vnd.kubernetes.protobuf;stream=watch":
            components["schemas"]["io.k8s.api.coordination.v1.LeaseList"]
          "application/yaml": components["schemas"]["io.k8s.api.coordination.v1.LeaseList"]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  createCoordinationV1NamespacedLease: {
    ...
    requestBody: {
      content: {
        "*/*": components["schemas"]["io.k8s.api.coordination.v1.Lease"]
      }
    }
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.coordination.v1.Lease"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.coordination.v1.Lease"]
          "application/yaml": components["schemas"]["io.k8s.api.coordination.v1.Lease"]
        }
      }
      /** @description Created */
      201: {
