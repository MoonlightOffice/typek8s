export interface paths {
  "/apis/autoscaling/v1/": {
    ...
    get: operations["getAutoscalingV1APIResources"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v1/horizontalpodautoscalers": {
    ...
    get: operations["listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers": {
    ...
    /** @description list or watch objects of kind HorizontalPodAutoscaler */
    get: operations["listAutoscalingV1NamespacedHorizontalPodAutoscaler"]
    put?: never
    /** @description create a HorizontalPodAutoscaler */
    post: operations["createAutoscalingV1NamespacedHorizontalPodAutoscaler"]
    /** @description delete collection of HorizontalPodAutoscaler */
    delete: operations["deleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler"]
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}": {
    ...
    get: operations["readAutoscalingV1NamespacedHorizontalPodAutoscaler"]
    /** @description replace the specified HorizontalPodAutoscaler */
    put: operations["replaceAutoscalingV1NamespacedHorizontalPodAutoscaler"]
    post?: never
    /** @description delete a HorizontalPodAutoscaler */
    delete: operations["deleteAutoscalingV1NamespacedHorizontalPodAutoscaler"]
    options?: never
    head?: never
    /** @description partially update the specified HorizontalPodAutoscaler */
    patch: operations["patchAutoscalingV1NamespacedHorizontalPodAutoscaler"]
    trace?: never
  }
  "/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status": {
    ...
    get: operations["readAutoscalingV1NamespacedHorizontalPodAutoscalerStatus"]
    /** @description replace status of the specified HorizontalPodAutoscaler */
    put: operations["replaceAutoscalingV1NamespacedHorizontalPodAutoscalerStatus"]
    post?: never
    delete?: never
    options?: never
    head?: never
    /** @description partially update status of the specified HorizontalPodAutoscaler */
    patch: operations["patchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus"]
    trace?: never
  }
  "/apis/autoscaling/v1/watch/horizontalpodautoscalers": {
    ...
    get: operations["watchAutoscalingV1HorizontalPodAutoscalerListForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers": {
    ...
    /** @description watch individual changes to a list of HorizontalPodAutoscaler. deprecated: use the 'watch' parameter with a list operation instead. */
    get: operations["watchAutoscalingV1NamespacedHorizontalPodAutoscalerList"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}": {
    ...
    get: operations["watchAutoscalingV1NamespacedHorizontalPodAutoscaler"]
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface components {
  schemas: {
    ...
    "io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler": {
       ...
       * @default {}
       */
      spec: components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerSpec"]
      /**
       * @description status is the current information about the autoscaler.
       * @default {}
       */
      status: components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerStatus"]
    }
    ...
    "io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList": {
      ...
      items: components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler"][]
      /** @description Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
      kind?: string
      /**
    ...
    "io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerSpec": {
       ...
       * @default {}
       */
      scaleTargetRef: components["schemas"]["io.k8s.api.autoscaling.v1.CrossVersionObjectReference"]
      /**
       * Format: int32
...
export interface operations {
  ...
  listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList"]
          "application/json;stream=watch":
            components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList"]
          "application/vnd.kubernetes.protobuf":
            components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList"]
          "application/vnd.kubernetes.protobuf;stream=watch":
            components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList"]
          "application/yaml": components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList"]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  createAutoscalingV1NamespacedHorizontalPodAutoscaler: {
    ...
    requestBody: {
      content: {
        "*/*": components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler"]
      }
    }
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler"]
          "application/vnd.kubernetes.protobuf":
            components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler"]
          "application/yaml": components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler"]
        }
      }
      /** @description Created */
      201: {
...
export interface api {
  HorizontalPodAutoscaler: Omit<components["schemas"]["io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler"], "status">
