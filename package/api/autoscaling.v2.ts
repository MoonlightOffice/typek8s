export interface paths {
  "/apis/autoscaling/v2/": {
    ...
    get: operations["getAutoscalingV2APIResources"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v2/horizontalpodautoscalers": {
    ...
    get: operations["listAutoscalingV2HorizontalPodAutoscalerForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers": {
    ...
    /** @description list or watch objects of kind HorizontalPodAutoscaler */
    get: operations["listAutoscalingV2NamespacedHorizontalPodAutoscaler"]
    put?: never
    /** @description create a HorizontalPodAutoscaler */
    post: operations["createAutoscalingV2NamespacedHorizontalPodAutoscaler"]
    /** @description delete collection of HorizontalPodAutoscaler */
    delete: operations["deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler"]
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}": {
    ...
    get: operations["readAutoscalingV2NamespacedHorizontalPodAutoscaler"]
    /** @description replace the specified HorizontalPodAutoscaler */
    put: operations["replaceAutoscalingV2NamespacedHorizontalPodAutoscaler"]
    post?: never
    /** @description delete a HorizontalPodAutoscaler */
    delete: operations["deleteAutoscalingV2NamespacedHorizontalPodAutoscaler"]
    options?: never
    head?: never
    /** @description partially update the specified HorizontalPodAutoscaler */
    patch: operations["patchAutoscalingV2NamespacedHorizontalPodAutoscaler"]
    trace?: never
  }
  "/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status": {
    ...
    get: operations["readAutoscalingV2NamespacedHorizontalPodAutoscalerStatus"]
    /** @description replace status of the specified HorizontalPodAutoscaler */
    put: operations["replaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus"]
    post?: never
    delete?: never
    options?: never
    head?: never
    /** @description partially update status of the specified HorizontalPodAutoscaler */
    patch: operations["patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus"]
    trace?: never
  }
  "/apis/autoscaling/v2/watch/horizontalpodautoscalers": {
    ...
    get: operations["watchAutoscalingV2HorizontalPodAutoscalerListForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v2/watch/namespaces/{namespace}/horizontalpodautoscalers": {
    ...
    /** @description watch individual changes to a list of HorizontalPodAutoscaler. deprecated: use the 'watch' parameter with a list operation instead. */
    get: operations["watchAutoscalingV2NamespacedHorizontalPodAutoscalerList"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/autoscaling/v2/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}": {
    ...
    get: operations["watchAutoscalingV2NamespacedHorizontalPodAutoscaler"]
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface components {
  schemas: {
    ...
    "io.k8s.api.autoscaling.v2.ContainerResourceMetricSource": {
       ...
       * @default {}
       */
      target: components["schemas"]["io.k8s.api.autoscaling.v2.MetricTarget"]
    }
    ...
    "io.k8s.api.autoscaling.v2.ContainerResourceMetricStatus": {
       ...
       * @default {}
       */
      current: components["schemas"]["io.k8s.api.autoscaling.v2.MetricValueStatus"]
      /**
       * @description name is the name of the resource in question.
       * @default
       */
    ...
    "io.k8s.api.autoscaling.v2.ExternalMetricSource": {
       ...
       * @default {}
       */
      metric: components["schemas"]["io.k8s.api.autoscaling.v2.MetricIdentifier"]
      /**
       * @description target specifies the target value for the given metric
       * @default {}
       */
    ...
    "io.k8s.api.autoscaling.v2.HPAScalingRules": {
      ...
      policies?: components["schemas"]["io.k8s.api.autoscaling.v2.HPAScalingPolicy"][]
    ...
    "io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler": {
       ...
       * @default {}
       */
      spec: components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerSpec"]
      /**
       * @description status is the current information about the autoscaler.
       * @default {}
       */
      status: components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerStatus"]
    }
    ...
    "io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerBehavior": {
      ...
      scaleDown?: components["schemas"]["io.k8s.api.autoscaling.v2.HPAScalingRules"]
      /**
       ...
       */
      scaleUp?: components["schemas"]["io.k8s.api.autoscaling.v2.HPAScalingRules"]
    }
    ...
    "io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerList": {
      ...
      items: components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler"][]
      /** @description Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
      kind?: string
      /**
    ...
    "io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerSpec": {
      ...
      behavior?: components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerBehavior"]
      /**
       * Format: int32
      ...
      metrics?: components["schemas"]["io.k8s.api.autoscaling.v2.MetricSpec"][]
      /**
       * Format: int32
       ...
       * @default {}
       */
      scaleTargetRef: components["schemas"]["io.k8s.api.autoscaling.v2.CrossVersionObjectReference"]
    }
    ...
    "io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerStatus": {
      ...
      conditions?: components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerCondition"][]
      /** @description currentMetrics is the last read state of the metrics used by this autoscaler. */
      currentMetrics?: components["schemas"]["io.k8s.api.autoscaling.v2.MetricStatus"][]
      /**
       * Format: int32
      ...
      lastScaleTime?: components["schemas"]["io.k8s.apimachinery.pkg.apis.meta.v1.Time"]
      /**
       * Format: int64
    ...
    "io.k8s.api.autoscaling.v2.MetricSpec": {
      ...
      containerResource?: components["schemas"]["io.k8s.api.autoscaling.v2.ContainerResourceMetricSource"]
      /** @description external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster). */
      external?: components["schemas"]["io.k8s.api.autoscaling.v2.ExternalMetricSource"]
      /** @description object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object). */
      object?: components["schemas"]["io.k8s.api.autoscaling.v2.ObjectMetricSource"]
      /** @description pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value. */
      pods?: components["schemas"]["io.k8s.api.autoscaling.v2.PodsMetricSource"]
      /** @description resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source. */
      resource?: components["schemas"]["io.k8s.api.autoscaling.v2.ResourceMetricSource"]
      /**
    ...
    "io.k8s.api.autoscaling.v2.MetricStatus": {
      ...
      containerResource?: components["schemas"]["io.k8s.api.autoscaling.v2.ContainerResourceMetricStatus"]
      /** @description external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster). */
      external?: components["schemas"]["io.k8s.api.autoscaling.v2.ExternalMetricStatus"]
      /** @description object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object). */
      object?: components["schemas"]["io.k8s.api.autoscaling.v2.ObjectMetricStatus"]
      /** @description pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value. */
      pods?: components["schemas"]["io.k8s.api.autoscaling.v2.PodsMetricStatus"]
      /** @description resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source. */
      resource?: components["schemas"]["io.k8s.api.autoscaling.v2.ResourceMetricStatus"]
      /**
    ...
    "io.k8s.api.autoscaling.v2.MetricTarget": {
      ...
      averageValue?: components["schemas"]["io.k8s.apimachinery.pkg.api.resource.Quantity"]
      /**
    ...
    "io.k8s.api.autoscaling.v2.ObjectMetricSource": {
       ...
       * @default {}
       */
      describedObject: components["schemas"]["io.k8s.api.autoscaling.v2.CrossVersionObjectReference"]
      /**
       * @description metric identifies the target metric by name and selector
       * @default {}
       */
  ...
  listAutoscalingV2HorizontalPodAutoscalerForAllNamespaces: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerList"]
          ...
          "application/vnd.kubernetes.protobuf;stream=watch":
            components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerList"]
          "application/yaml": components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerList"]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  createAutoscalingV2NamespacedHorizontalPodAutoscaler: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler"]
          "application/vnd.kubernetes.protobuf":
            components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler"]
          "application/yaml": components["schemas"]["io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler"]
        }
      }
      /** @description Created */
      201: {
