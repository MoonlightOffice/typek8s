export interface paths {
  "/apis/scheduling.k8s.io/v1/": {
    ...
    get: operations["getSchedulingV1APIResources"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/scheduling.k8s.io/v1/priorityclasses": {
    ...
    get: operations["listSchedulingV1PriorityClass"]
    put?: never
    /** @description create a PriorityClass */
    post: operations["createSchedulingV1PriorityClass"]
    /** @description delete collection of PriorityClass */
    delete: operations["deleteSchedulingV1CollectionPriorityClass"]
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  "/apis/scheduling.k8s.io/v1/priorityclasses/{name}": {
    ...
    get: operations["readSchedulingV1PriorityClass"]
    /** @description replace the specified PriorityClass */
    put: operations["replaceSchedulingV1PriorityClass"]
    post?: never
    /** @description delete a PriorityClass */
    delete: operations["deleteSchedulingV1PriorityClass"]
    options?: never
    head?: never
    /** @description partially update the specified PriorityClass */
    patch: operations["patchSchedulingV1PriorityClass"]
    trace?: never
  }
  "/apis/scheduling.k8s.io/v1/watch/priorityclasses": {
    ...
    get: operations["watchSchedulingV1PriorityClassList"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/scheduling.k8s.io/v1/watch/priorityclasses/{name}": {
    ...
    get: operations["watchSchedulingV1PriorityClass"]
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface components {
  schemas: {
    ...
    "io.k8s.api.scheduling.v1.PriorityClassList": {
      ...
      items: components["schemas"]["io.k8s.api.scheduling.v1.PriorityClass"][]
      /** @description Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
      kind?: string
      /**
...
export interface operations {
  ...
  listSchedulingV1PriorityClass: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClassList"]
          "application/json;stream=watch": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClassList"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClassList"]
          "application/vnd.kubernetes.protobuf;stream=watch":
            components["schemas"]["io.k8s.api.scheduling.v1.PriorityClassList"]
          "application/yaml": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClassList"]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  createSchedulingV1PriorityClass: {
    ...
    requestBody: {
      content: {
        "*/*": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClass"]
      }
    }
    responses: {
      /** @description OK */
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClass"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClass"]
          "application/yaml": components["schemas"]["io.k8s.api.scheduling.v1.PriorityClass"]
        }
      }
      /** @description Created */
      201: {
