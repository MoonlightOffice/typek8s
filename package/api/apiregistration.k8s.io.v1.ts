export interface paths {
  "/apis/apiregistration.k8s.io/v1/": {
    ...
    get: operations["getApiregistrationV1APIResources"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/apiregistration.k8s.io/v1/apiservices": {
    ...
    get: operations["listApiregistrationV1APIService"]
    put?: never
    /** @description create an APIService */
    post: operations["createApiregistrationV1APIService"]
    /** @description delete collection of APIService */
    delete: operations["deleteApiregistrationV1CollectionAPIService"]
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  "/apis/apiregistration.k8s.io/v1/apiservices/{name}": {
    ...
    get: operations["readApiregistrationV1APIService"]
    /** @description replace the specified APIService */
    put: operations["replaceApiregistrationV1APIService"]
    post?: never
    /** @description delete an APIService */
    delete: operations["deleteApiregistrationV1APIService"]
    options?: never
    head?: never
    /** @description partially update the specified APIService */
    patch: operations["patchApiregistrationV1APIService"]
    trace?: never
  }
  "/apis/apiregistration.k8s.io/v1/apiservices/{name}/status": {
    ...
    get: operations["readApiregistrationV1APIServiceStatus"]
    /** @description replace status of the specified APIService */
    put: operations["replaceApiregistrationV1APIServiceStatus"]
    post?: never
    delete?: never
    options?: never
    head?: never
    /** @description partially update status of the specified APIService */
    patch: operations["patchApiregistrationV1APIServiceStatus"]
    trace?: never
  }
  "/apis/apiregistration.k8s.io/v1/watch/apiservices": {
    ...
    get: operations["watchApiregistrationV1APIServiceList"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/apiregistration.k8s.io/v1/watch/apiservices/{name}": {
    ...
    get: operations["watchApiregistrationV1APIService"]
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface components {
  schemas: {
    ...
    "io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService": {
       ...
       * @default {}
       */
      spec: components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec"]
      /**
       * @description Status contains derived information about an API server
       * @default {}
       */
      status: components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceStatus"]
    }
    ...
    "io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList": {
      ...
      items: components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService"][]
      /** @description Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
      kind?: string
      /**
    ...
    "io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec": {
      ...
      service?: components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.ServiceReference"]
    ...
    "io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceStatus": {
      ...
      conditions?: components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceCondition"][]
    }
  ...
  listApiregistrationV1APIService: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList"]
          ...
          "application/vnd.kubernetes.protobuf;stream=watch":
            components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList"]
          "application/yaml": components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList"]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  createApiregistrationV1APIService: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService"]
          "application/vnd.kubernetes.protobuf":
            components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService"]
          "application/yaml": components["schemas"]["io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService"]
        }
      }
      /** @description Created */
      201: {
