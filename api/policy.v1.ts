export interface paths {
  "/apis/policy/v1/": {
    ...
    get: operations["getPolicyV1APIResources"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets": {
    ...
    get: operations["listPolicyV1NamespacedPodDisruptionBudget"]
    put?: never
    /** @description create a PodDisruptionBudget */
    post: operations["createPolicyV1NamespacedPodDisruptionBudget"]
    /** @description delete collection of PodDisruptionBudget */
    delete: operations["deletePolicyV1CollectionNamespacedPodDisruptionBudget"]
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}": {
    ...
    get: operations["readPolicyV1NamespacedPodDisruptionBudget"]
    /** @description replace the specified PodDisruptionBudget */
    put: operations["replacePolicyV1NamespacedPodDisruptionBudget"]
    post?: never
    /** @description delete a PodDisruptionBudget */
    delete: operations["deletePolicyV1NamespacedPodDisruptionBudget"]
    options?: never
    head?: never
    /** @description partially update the specified PodDisruptionBudget */
    patch: operations["patchPolicyV1NamespacedPodDisruptionBudget"]
    trace?: never
  }
  "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status": {
    ...
    get: operations["readPolicyV1NamespacedPodDisruptionBudgetStatus"]
    /** @description replace status of the specified PodDisruptionBudget */
    put: operations["replacePolicyV1NamespacedPodDisruptionBudgetStatus"]
    post?: never
    delete?: never
    options?: never
    head?: never
    /** @description partially update status of the specified PodDisruptionBudget */
    patch: operations["patchPolicyV1NamespacedPodDisruptionBudgetStatus"]
    trace?: never
  }
  "/apis/policy/v1/poddisruptionbudgets": {
    ...
    /** @description list or watch objects of kind PodDisruptionBudget */
    get: operations["listPolicyV1PodDisruptionBudgetForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets": {
    ...
    get: operations["watchPolicyV1NamespacedPodDisruptionBudgetList"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}": {
    ...
    get: operations["watchPolicyV1NamespacedPodDisruptionBudget"]
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  "/apis/policy/v1/watch/poddisruptionbudgets": {
    ...
    /** @description watch individual changes to a list of PodDisruptionBudget. deprecated: use the 'watch' parameter with a list operation instead. */
    get: operations["watchPolicyV1PodDisruptionBudgetListForAllNamespaces"]
    put?: never
    post?: never
    delete?: never
    options?: never
...
export interface components {
  schemas: {
    ...
    "io.k8s.api.policy.v1.PodDisruptionBudget": {
       ...
       * @default {}
       */
      spec: components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudgetSpec"]
      /**
       * @description Most recently observed status of the PodDisruptionBudget.
       * @default {}
       */
      status: components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudgetStatus"]
    }
    ...
    "io.k8s.api.policy.v1.PodDisruptionBudgetList": {
      ...
      items: components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudget"][]
      /** @description Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds */
      kind?: string
      /**
       * @description Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
    ...
    "io.k8s.api.policy.v1.PodDisruptionBudgetStatus": {
      ...
      disruptedPods?: {
        [key: string]: components["schemas"]["io.k8s.apimachinery.pkg.apis.meta.v1.Time"]
      }
      /**
       * Format: int32
  ...
  listPolicyV1NamespacedPodDisruptionBudget: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudgetList"]
          "application/json;stream=watch": components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudgetList"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudgetList"]
          "application/vnd.kubernetes.protobuf;stream=watch":
            components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudgetList"]
          "application/yaml": components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudgetList"]
        }
      }
      /** @description Unauthorized */
      401: {
  ...
  createPolicyV1NamespacedPodDisruptionBudget: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudget"]
          "application/vnd.kubernetes.protobuf": components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudget"]
          "application/yaml": components["schemas"]["io.k8s.api.policy.v1.PodDisruptionBudget"]
        }
      }
      /** @description Created */
      201: {
